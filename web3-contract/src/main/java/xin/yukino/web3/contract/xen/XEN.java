...
public class XEN {
    ...
    public static EthSendTransaction claimRank(int term, String contractAddress, Credentials credentials, ChainEnum chain) {
    ...
    public static EthSendTransaction claimMintReward(String contractAddress, Credentials credentials, ChainEnum chain) {
