...
public class GasBackMSGHelper {
    ...
    public static List<Type> genRegisterMsg(String contract, String withdraw, List<Integer> nonceList, String contractAddress, Credentials credentials, ChainEnum chain) {
    ...
    public static List<Type> genCancelMsg(String contract, String contractAddress, Credentials credentials, ChainEnum chain) {
