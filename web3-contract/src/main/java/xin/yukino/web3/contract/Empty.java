...
public class Empty {
    ...
    public static EthSendTransaction transferEmpty(Credentials credentials, IChain chain) {
        return TransactionUtil.transfer(credentials.getAddress(), BigDecimal.valueOf(0.0001), credentials, chain);
    }

    public static EthSendTransaction callEmpty(String contract, Credentials credentials, IChain chain) {
